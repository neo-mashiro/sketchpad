...
namespace scene {
    ...
    */
    ...
    class Scene01 : public Scene {
        ...
        asset_ref<SSBO> pl_color_ssbo;  // glm::vec4
        asset_ref<SSBO> pl_position_ssbo;  // glm::vec4
        asset_ref<SSBO> pl_range_ssbo;  // GLfloat
        asset_ref<SSBO> pl_index_ssbo;  // GLint

        // utility shaders that are directly controlled by the user
        std::unique_ptr<CShader> light_cull_shader;
