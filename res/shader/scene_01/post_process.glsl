...
void main() {
    ...
    // tone mapping typically does not apply to the bloom part as it's blurred and contains no
    // detail, just add bloom to the tonemapped pixel color and let RGB clipping does its work
